		...
		switch (type) {
			...
			case "insert_to_editor":
				...
				while ((startPos = content.indexOf('<embed', startPos+1)) != -1) {
					...
					var attribs = TinyMCE_MatsueMoviePlugin._parseAttributes(content.substring(startPos + 6, endPos));
				...
				while ((startPos = content.indexOf('<object', startPos)) != -1) {
					...
					content += ' alt="' + attribs["src"] + '" class="mceItemMatsueMovie" />' + content.substring(endPos);
			...
			case "get_from_editor":
				...
				while ((startPos = content.indexOf('<img', startPos+1)) != -1) {
					...
					if( src.indexOf("http://matsuesns.jp/rmovie/show/") > -1 )
						src = src.replace("http://matsuesns.jp/rmovie/show/", "");
//meme_custom
					if( src.indexOf("https://matsuesns.jp/rmovie/show/") > -1 )
						src = src.replace("https://matsuesns.jp/rmovie/show/", "");
